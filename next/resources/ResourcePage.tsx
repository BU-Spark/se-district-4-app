...
export default function ResourcePage() {
    const resources = [
        ...
        { title: "Sober Homes", image: assets.location },
        ...
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {upcomingevents.map((items, index) => (
                    ...
                    >
                        <Image src={assets.house} alt="White House" className="w-full h-auto" />
                        <div className="p-4">
                            <p className="text-xl mb-2">{items.heading}</p>
                            <p className="italic">{items.content}</p>
                            <p className="mt-3 text-sm text-gray-300">Date: {items.date}</p>
                        </div>
                    </a>
                ))}
